...
1. **Sparkle 对所有 provider 都加载用户级 Claude 设置**，当前机器的 `~/.claude/settings.json` 开着：
...
- **最高优先级根因**：用户级 Claude 设置泄漏进 Sparkle，会把所有 provider 都拉进高 effort / always-thinking 路径。
...
- [`src/lib/provider-resolver.ts`](/Users/guohao/Documents/code/codepilot/Sparkle/src/lib/provider-resolver.ts)

同时 SDK 只在显式传入时才追加 `--effort`：

- [`src/lib/claude-client.ts`](/Users/guohao/Documents/code/codepilot/Sparkle/src/lib/claude-client.ts)
- [`node_modules/@anthropic-ai/claude-agent-sdk/sdk.mjs`](/Users/guohao/Documents/code/codepilot/Sparkle/node_modules/@anthropic-ai/claude-agent-sdk/sdk.mjs)
...
- 即使 Sparkle UI 没主动把 effort 选到 high，只要没有显式覆盖，SDK 很可能仍继承用户级默认值。
...
- [`src/app/api/chat/route.ts`](/Users/guohao/Documents/code/codepilot/Sparkle/src/app/api/chat/route.ts)
- [`src/lib/assistant-workspace.ts`](/Users/guohao/Documents/code/codepilot/Sparkle/src/lib/assistant-workspace.ts)
- [`src/lib/workspace-indexer.ts`](/Users/guohao/Documents/code/codepilot/Sparkle/src/lib/workspace-indexer.ts)
- [`src/lib/workspace-retrieval.ts`](/Users/guohao/Documents/code/codepilot/Sparkle/src/lib/workspace-retrieval.ts)
...
- [`src/lib/cli-tools-context.ts`](/Users/guohao/Documents/code/codepilot/Sparkle/src/lib/cli-tools-context.ts)
- [`src/lib/cli-tools-detect.ts`](/Users/guohao/Documents/code/codepilot/Sparkle/src/lib/cli-tools-detect.ts)
...
1. Sparkle 显式注入的 `loadMcpServers()`
...
- [`src/app/api/chat/route.ts`](/Users/guohao/Documents/code/codepilot/Sparkle/src/app/api/chat/route.ts)
- [`.mcp.json`](/Users/guohao/Documents/code/codepilot/Sparkle/.mcp.json)
...
- [`src/lib/claude-client.ts`](/Users/guohao/Documents/code/codepilot/Sparkle/src/lib/claude-client.ts)
- [`src/hooks/useSSEStream.ts`](/Users/guohao/Documents/code/codepilot/Sparkle/src/hooks/useSSEStream.ts)
- [`docs/handover/provider-error-doctor.md`](/Users/guohao/Documents/code/codepilot/Sparkle/docs/handover/provider-error-doctor.md)
...
1. **不要让 Sparkle 默认继承 `~/.claude/settings.json` 的 thinking / effort**
   - 最稳妥：对 provider 会话去掉 `user` setting source
   - 或者在 Sparkle 里显式传默认值，例如：
