...
| **Session Tree 分支** | 中——当前 Sparkle 不支持分支 | 未来功能 |

### 不适用的方案

| Pi 特性 | 原因 |
|---------|------|
| TypeBox + AJV | Sparkle 统一用 Zod + Vercel AI SDK |
| 反 MCP 立场 | Sparkle 保留 MCP 支持 |
| 无子 Agent | Sparkle 计划支持子 Agent |
| TUI 渲染 | Sparkle 是桌面 GUI |
