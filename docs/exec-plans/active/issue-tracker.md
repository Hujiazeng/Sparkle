...
- **Issues:** [#456](https://github.com/op7418/Sparkle/issues/456), [#461](https://github.com/op7418/Sparkle/issues/461), [#474](https://github.com/op7418/Sparkle/issues/474), [#478](https://github.com/op7418/Sparkle/issues/478), [#476](https://github.com/op7418/Sparkle/issues/476), [#457](https://github.com/op7418/Sparkle/issues/457), [#470](https://github.com/op7418/Sparkle/issues/470)
...
- **Issues:** [#464](https://github.com/op7418/Sparkle/issues/464)
...
- **Issues:** [#465](https://github.com/op7418/Sparkle/issues/465), [#466](https://github.com/op7418/Sparkle/issues/466) 评论, [#477](https://github.com/op7418/Sparkle/issues/477)（默认模型不生效）
...
- **未修原因：**
  ...
  - 第三方某些较弱模型（如部分 GLM/Kimi 变体）确实可能对 `show-widget` 格式遵循度低，但这是**模型能力问题**而非 Sparkle 代码 bug
- **下一步:** 在 issue #471 回复请用户升 v0.50.1+ 重测；如果仍现，索取具体 provider/model 配置

#### B-006 会话切换模型重置
- **Issues:** [#462](https://github.com/op7418/Sparkle/issues/462)
- **状态:** 🟡 可能和 B-004 相关
...
- **Issues:** [#470](https://github.com/op7418/Sparkle/issues/470)
...
- **Issue:** [#244](https://github.com/op7418/Sparkle/issues/244)
- **状态:** 🔴 未修复
- **根因:** `child_process.spawn()` 缺少 `windowsHide: true`
- **修复方向:** `claude-client.ts` spawn 调用加 `windowsHide: true`

#### B-011 中文输入法回车误发送消息
- **Issue:** [#225](https://github.com/op7418/Sparkle/issues/225)
- **状态:** 🔴 未修复
...
- **Issue:** [#455](https://github.com/op7418/Sparkle/issues/455)
...
- **Issues:** [#323](https://github.com/op7418/Sparkle/issues/323), [#288](https://github.com/op7418/Sparkle/issues/288), [#199](https://github.com/op7418/Sparkle/issues/199), [#149](https://github.com/op7418/Sparkle/issues/149), [#148](https://github.com/op7418/Sparkle/issues/148)
- **状态:** ⚪ 需重新诊断
...
- **Issue:** [#465](https://github.com/op7418/Sparkle/issues/465) 附带反馈
- **状态:** 🔴 未修复
- **描述:** 导入 Claude Code 会话需要一个个手动选择，无批量选择

#### B-019 SDK runtime + 慢 provider 首包静默撞 330s Stream idle timeout
- **Issue:** [#499](https://github.com/op7418/Sparkle/issues/499)
...
- **Issue:** [#501](https://github.com/op7418/Sparkle/issues/501)
...
- **维护者环境不复现**（两台机器均未触发）；报告者（vivi2886）使用第三方 API Key，Sparkle DB 无 OAuth token 记录也仍触发
- **根因诊断:**
...
- **Issues:** [#231](https://github.com/op7418/Sparkle/issues/231), [#229](https://github.com/op7418/Sparkle/issues/229)
- **状态:** 🔴 未修复
- **根因:** Bridge 走 SDK `query()`，斜杠命令不被 CLI 处理

#### B-016 Windows 卸载卡住
- **Issue:** [#454](https://github.com/op7418/Sparkle/issues/454)
...
| Issue | 描述 | 状态 | 备注 |
|-------|------|------|------|
| [#469](https://github.com/op7418/Sparkle/issues/469) | 一键导入 + 浏览 Claude Code 对话历史 | 🟡 部分满足 | v0.49.0 `codepilot_session_search` 解决了搜索，可视化浏览未做 |
| [#473](https://github.com/op7418/Sparkle/issues/473) | 语音交互 STT/TTS | 📋 待评估 | |
| [#460](https://github.com/op7418/Sparkle/issues/460) | 定时任务 | 📋 待评估 | |
| [#459](https://github.com/op7418/Sparkle/issues/459) | 左侧 UI 采用 Codex 文案风格 | 📋 待评估 | |
| [#458](https://github.com/op7418/Sparkle/issues/458) | 多 OpenAI OAuth 账号 | 📋 待评估 | |
| [#463](https://github.com/op7418/Sparkle/issues/463) | 代码界面可编辑 + 语法高亮 | 🔵 设计如此 | Claude Code 理念：AI 写 100% 代码 |
| [#246](https://github.com/op7418/Sparkle/issues/246) | 应用内自动更新 | 📋 待实现 | 已有 electron-updater 依赖 |
| [#254](https://github.com/op7418/Sparkle/issues/254) | 会话列表待确认状态指示 | 📋 待实现 | |
| [#236](https://github.com/op7418/Sparkle/issues/236) | @ 自动补全文件路径 | 📋 待实现 | |
| [#242](https://github.com/op7418/Sparkle/issues/242) | 多 bot 桥接 | 📋 待实现 | 高复杂度 |
| [#234](https://github.com/op7418/Sparkle/issues/234) | Codex / 多 CLI 后端支持 | 📋 长期规划 | |
...
- [#466](https://github.com/op7418/Sparkle/issues/466) 用户建议增加内测版流程，在内部群测试通过后再发布正式版
