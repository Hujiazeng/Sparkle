...
### macOS
- [Apple Silicon (M1/M2/M3/M4)](https://github.com/Hujiazeng/Sparkle/releases/download/v0.54.0/Sparkle-0.54.0-arm64.dmg)
- [Intel](https://github.com/Hujiazeng/Sparkle/releases/download/v0.54.0/Sparkle-0.54.0-x64.dmg)

### Windows
- [Windows 安装包](https://github.com/Hujiazeng/Sparkle/releases/download/v0.54.0/Sparkle.Setup.0.54.0.exe)
