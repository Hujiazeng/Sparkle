...
function createTray(): void {
  ...
  tray.setToolTip('Sparkle — Bridge Active');
...
function checkNativeModuleABI(): void {
  ...
  try {
    ...
    if (msg.includes('NODE_MODULE_VERSION')) {
      ...
      dialog.showErrorBox(
        'Sparkle - Native Module ABI Mismatch',
 ...
 * uncommon in practice. 8 candidates handles up to 8 concurrent Sparkle
