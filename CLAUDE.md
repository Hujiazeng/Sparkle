...
Sparkle — 多模型 AI Agent 桌面客户端，基于 Electron + Next.js。
...
### macOS
- [Apple Silicon (M1/M2/M3/M4)](https://github.com/Hujiazeng/Sparkle/releases/download/v{版本号}/Sparkle-{版本号}-arm64.dmg)
- [Intel](https://github.com/Hujiazeng/Sparkle/releases/download/v{版本号}/Sparkle-{版本号}-x64.dmg)

### Windows
- [Windows 安装包](https://github.com/Hujiazeng/Sparkle/releases/download/v{版本号}/Sparkle.Setup.{版本号}.exe)
