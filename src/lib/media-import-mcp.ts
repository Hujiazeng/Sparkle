  ...
  return createSdkMcpServer({
    ...
    tools: [
      tool(
        ...
        'Import a local file (image, video, audio) into the Sparkle media library. Use this when the user asks to save a generated or downloaded media file to the library. The file must exist on disk. Always fill in prompt, model, resolution, and source when available.',
        {
