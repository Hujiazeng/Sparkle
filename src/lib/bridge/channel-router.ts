/**
 * Channel Router — resolves IM addresses to Sparkle sessions.
 *
...
/**
 * Create a new binding with a fresh Sparkle session.
 */
...
/**
 * Bind an IM chat to an existing Sparkle session.
 */
