...
export function toClaudeCodeEnv(
  ...
  // (model aliases, AWS/OTEL/Bedrock keys — see rG6 in cli.js), and when Sparkle
...
function buildResolution(
  ...
  // automatically discover user-scoped features that Sparkle does NOT
  // pass explicitly:
  ...
  // users don't author project-level Claude Code config, and Sparkle has
...
//
// Sparkle background: provider preset's roleModels.small slot is
