 ...
 * parallelize. Matches Sparkle's core tool names plus built-in
 ...
 * `shouldParallelizeToolBatch` because Sparkle's `Bash` tool is not in
 ...
 *
 * Sparkle's Write / Edit tools use `file_path` as the arg key while
