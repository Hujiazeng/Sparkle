...
const zh: Record<TranslationKey, string> = {
  ...
  'nav.mcp': 'MCP',
  'nav.gallery': '素材库',
  'nav.creationCenter': '创作中心',
  'nav.digitalHuman': '数字人',
  'nav.voices': '音色',
  ...
  'windowBar.paste': '粘贴',
  'windowBar.find': '查找',
  'windowBar.toggleSidebar': '切换侧边栏',
  'windowBar.openBrowserTab': '打开浏览器标签',
  'windowBar.reloadBrowserPage': '重新加载页面',
  'windowBar.zoomIn': '放大',
  'windowBar.zoomOut': '缩小',
  'windowBar.actualSize': '实际大小',
  'windowBar.toggleFullScreen': '切换全屏',
  'windowBar.minimize': '最小化',
  'windowBar.zoom': '缩放',
  'windowBar.zoomFullScreen': '缩放/全屏',
  'windowBar.back': '后退',
  'windowBar.forward': '前进',
  'windowBar.docs': '文档',
  ...
  // ── Message list ────────────────────────────────────────────
  'messageList.claudeChat': 'Sparkle 对话',
  'messageList.emptyDescription': '开始与 Sparkle 对话。提问、获取代码帮助或探索想法。',
  ...
  // ── Settings: General ───────────────────────────────────────
  'settings.title': '设置',
  'settings.description': '管理创作中心和数字人配置',
  'settings.general': '通用',
  'settings.apiKey': 'APIKEY',
  'settings.providers': '服务商',
  'settings.digitalHuman': '数字人',
  ...
  'settings.autoApproveTitle': '自动批准后台操作',
  'settings.autoApproveDesc': '保留给需要自动执行本地操作的高级流程。通常建议保持关闭。',
  'settings.autoApproveWarning': '后台操作将在无确认的情况下自动批准。请谨慎使用。',
  'settings.autoApproveDialogTitle': '启用自动批准后台操作？',
  'settings.autoApproveDialogDesc': '这将绕过部分权限确认。后台流程可能在不征求您确认的情况下执行操作，包括：',
  'settings.autoApproveShellCommands': '运行任意 Shell 命令',
  'settings.autoApproveFileOps': '读取、写入和删除文件',
  'settings.autoApproveNetwork': '发起网络请求',
  'settings.autoApproveTrustWarning': '仅在您完全信任当前工作流时才启用此选项。',
  'settings.cancel': '取消',
  'settings.enableAutoApprove': '启用自动批准',
  'settings.errorReporting': '匿名错误上报',
  'settings.errorReportingDesc': '帮助改进 Sparkle：匿名上报错误信息，不包含对话内容和 API Key。更改后需重启应用才能完全生效。',
  'settings.generativeUITitle': '生成式界面',
  'settings.generativeUIDesc': '保留给可视化生成能力。当前创作中心入口不依赖此功能。',
  'settings.defaultPanelTitle': '默认面板',
  'settings.defaultPanelDesc': '保留给旧工作台面板的默认展开设置。',
  ...
  'settings.appearanceDesc': '自定义 Sparkle 的外观和风格',
  ...
  'cli.agentRuntimeDesc': '选择 Sparkle 执行 Agent 任务的方式',
  ...
  'connection.gitInstallSuccess': 'Git 安装成功！请重启 Sparkle。',
  ...
  'connection.upgradeSuccess': '升级成功！请重启 Sparkle 以应用更新。',
  ...
  'update.readyToInstall': 'Sparkle v{version} 已就绪 — 重启以完成更新',
  'update.installUpdate': '下载并安装',
  'update.later': '稍后',
  'update.requiredTitle': '需要更新',
  'update.requiredMessage': '当前版本已不再支持，请更新 Sparkle 后继续使用。',
  'update.minSupportedVersion': '最低支持版本：v{version}',
  'update.rosettaWarning': 'Sparkle 当前正通过 Rosetta 在这台 Apple Silicon Mac 上运行。安装 arm64 版本可获得更好的响应速度。',
  ...
  'feishu.quickCreateDesc': '自动创建飞书机器人并绑定到 Sparkle，无需手动配置权限和事件',
  ...
  'mcp.enabled': '已启用',
  'mcp.disabled': '已禁用',
  'mcp.managerDesc': '开关控制 Sparkle 注入的 MCP 服务。Claude Code 自身配置中的服务仍可能被 SDK 通过 settingSources 自动加载。',
  ...
  'cliTools.viewDocs': '查看 Sparkle 官方文档',
  ...
  // ── Setup Center ──────────────────────────────────────────────
  'setup.title': '欢迎使用 Sparkle',
  'setup.subtitle': '配置数字人 API 和默认工作目录。',
  'setup.skipAndEnter': '跳过并进入',
  'setup.progress': '{completed}/{total} 已完成',
  'setup.openSetupCenter': '首次设置引导',
  'setup.openSetupCenterDesc': '配置数字人 API 和默认项目目录',
  'setup.open': '打开',

  // Setup: Welcome card
  'setup.welcome.title': '欢迎',
  'setup.welcome.description': 'Sparkle 是多模型 AI Agent 桌面客户端。连接任意 AI 服务商，通过 MCP 和 Skills 扩展能力，让你的助理学会你的工作方式。',
  ...
  'setup.provider.description': '配置 Sparkle 连接 AI 模型的方式。',
