...
const en = {
  ...
  'nav.mcp': 'MCP',
  'nav.gallery': 'Gallery',
  'nav.creationCenter': 'Creation Center',
  'nav.digitalHuman': 'Digital Human',
  'nav.voices': 'Voices',

  // ── Window bar ──────────────────────────────────────────────
  'windowBar.menu': 'Window menu',
  'windowBar.file': 'File',
  'windowBar.edit': 'Edit',
  'windowBar.view': 'View',
  'windowBar.window': 'Window',
  'windowBar.help': 'Help',
  'windowBar.close': 'Close',
  ...
  'windowBar.cut': 'Cut',
  'windowBar.copy': 'Copy',
  'windowBar.paste': 'Paste',
  'windowBar.find': 'Find',
  'windowBar.toggleSidebar': 'Toggle Sidebar',
  'windowBar.openBrowserTab': 'Open Browser Tab',
  'windowBar.reloadBrowserPage': 'Reload Browser Page',
  'windowBar.zoomIn': 'Zoom In',
  'windowBar.zoomOut': 'Zoom Out',
  'windowBar.actualSize': 'Actual Size',
  'windowBar.toggleFullScreen': 'Toggle Full Screen',
  'windowBar.minimize': 'Minimize',
  'windowBar.zoom': 'Zoom',
  'windowBar.zoomFullScreen': 'Zoom / Full Screen',
  'windowBar.back': 'Back',
  'windowBar.forward': 'Forward',
  'windowBar.docs': 'Documentation',
  ...
  // ── Message list ────────────────────────────────────────────
  'messageList.claudeChat': 'Sparkle Chat',
  'messageList.emptyDescription': 'Start a conversation with Sparkle. Ask questions, get help with code, or explore ideas.',
  ...
  'settings.description': 'Manage creation center and digital human settings',
  'settings.general': 'General',
  'settings.apiKey': 'APIKEY',
  'settings.providers': 'Providers',
  'settings.digitalHuman': 'Digital Human',
  'settings.claudeCli': 'Claude Code',
  'settings.codepilot': 'Sparkle',
  ...
  'settings.autoApproveTitle': 'Auto-approve Background Actions',
  'settings.autoApproveDesc': 'Reserved for advanced local automation flows. Usually this should stay off.',
  'settings.autoApproveWarning': 'Background actions will be auto-approved without confirmation. Use with caution.',
  'settings.autoApproveDialogTitle': 'Enable Auto-approve Background Actions?',
  'settings.autoApproveDialogDesc': 'This will bypass some permission prompts. Background flows may execute actions without asking for your confirmation, including:',
  ...
  'settings.autoApproveTrustWarning': 'Only enable this if you fully trust the current workflow.',
  'settings.cancel': 'Cancel',
  'settings.enableAutoApprove': 'Enable Auto-approve',
  'settings.errorReporting': 'Anonymous Error Reporting',
  'settings.errorReportingDesc': 'Help improve Sparkle by anonymously reporting errors. No conversation content or API keys are included. Restart the app for the change to fully take effect.',
  'settings.generativeUITitle': 'Generative Interface',
  'settings.generativeUIDesc': 'Reserved for visual generation capability. The current creation center entry points do not depend on it.',
  'settings.defaultPanelTitle': 'Default Panel',
  'settings.defaultPanelDesc': 'Reserved for legacy workbench panel defaults.',
  ...
  'settings.appearanceDesc': 'Customize the look and feel of Sparkle',
  ...
  'cli.agentRuntimeDesc': 'Choose how Sparkle executes agent tasks',
  ...
  'connection.gitInstallSuccess': 'Git installed successfully! Please restart Sparkle.',
  ...
  'connection.upgradeSuccess': 'Upgrade successful! Please restart Sparkle to apply the update.',
  ...
  'update.readyToInstall': 'Sparkle v{version} is ready — restart to update',
  'update.installUpdate': 'Download & Install',
  'update.later': 'Later',
  'update.requiredTitle': 'Update Required',
  'update.requiredMessage': 'This version is no longer supported. Update Sparkle to continue.',
  'update.minSupportedVersion': 'Minimum supported version: v{version}',
  'update.rosettaWarning': 'Sparkle is running through Rosetta on this Apple Silicon Mac. Install the arm64 build for better responsiveness.',
  ...
  'feishu.quickCreateDesc': 'Auto-create a Feishu bot and bind it to Sparkle — no manual permission or event setup needed',
  ...
  'mcp.managerDesc': 'Toggle controls Sparkle MCP injection. Servers in your Claude Code config may still be loaded by the SDK via its own settings sources.',
  ...
  'cliTools.viewDocs': 'View Sparkle documentation',
  ...
  // ── Setup Center ──────────────────────────────────────────────
  'setup.title': 'Welcome to Sparkle',
  'setup.subtitle': 'Configure your digital human API and workspace.',
  'setup.skipAndEnter': 'Skip and Enter',
  'setup.progress': '{completed}/{total} completed',
  'setup.openSetupCenter': 'Initial Setup Guide',
  'setup.openSetupCenterDesc': 'Configure the digital human API and default project directory',
  'setup.open': 'Open',

  // Setup: Welcome card
  'setup.welcome.title': 'Welcome',
  'setup.welcome.description': 'Sparkle is a multi-model AI agent desktop client. Connect any AI provider, extend with MCP & skills, and let your assistant learn your workflow.',

  // Setup: Claude Code card
  'setup.claude.title': 'Claude Code CLI (Optional)',
  'setup.claude.description': 'Install Claude Code CLI for full command-line capabilities. Sparkle works without it via the AI SDK engine.',
  ...
  'setup.provider.description': 'Configure how Sparkle connects to AI models.',
