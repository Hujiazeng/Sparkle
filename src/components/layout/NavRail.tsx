...
const navItems = [
  ...
  { href: "/creation-center", label: "Creation Center", icon: RowsPlusBottom },
  { href: "/digital-human", label: "Digital Human", icon: UserFocus },
  { href: "/voices", label: "Voices", icon: Waveform },
...
export function NavRail({ onToggleChatList, hasUpdate, readyToInstall, skipPermissionsActive }: NavRailProps) {
  ...
  const navLabelKeys: Record<string, TranslationKey> = {
    ...
    'Creation Center': 'nav.creationCenter',
    'Digital Human': 'nav.digitalHuman',
    'Voices': 'nav.voices',
    'Bridge': 'nav.bridge',
