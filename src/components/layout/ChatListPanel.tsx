...
export function ChatListPanel({ open, width, hasUpdate, readyToInstall }: ChatListPanelProps) {
  ...
  const navItems = [
    ...
    { href: "/creation-center", label: t('nav.creationCenter' as TranslationKey), icon: RowsPlusBottom },
    { href: "/digital-human", label: t('nav.digitalHuman' as TranslationKey), icon: UserFocus },
    { href: "/voices", label: t('nav.voices' as TranslationKey), icon: Waveform },
