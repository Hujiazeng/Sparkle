...
import { type Icon, Gear, Key } from "@/components/ui/icon";
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";
import { GeneralSection } from "./GeneralSection";
import { DigitalHumanSettingsSection } from "./DigitalHumanSettingsSection";
import { useTranslation } from "@/hooks/useTranslation";
import type { TranslationKey } from "@/i18n";

type Section = "general" | "digital-human";
...
const sidebarItems: SidebarItem[] = [
  ...
  { id: "digital-human", label: "APIKEY", icon: Key },
];
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <div className="flex-1 overflow-auto p-6">
          ...
          {activeSection === "digital-human" && <DigitalHumanSettingsSection />}
        </div>
      </div>
    </div>
  );
