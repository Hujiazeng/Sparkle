 ...
 *
 * Tests verify:
 * 1. loadSparkleMcpServers returns undefined when no servers have ${...} placeholders
 * 2. loadSparkleMcpServers returns only servers with resolved placeholders
...
import { loadSparkleMcpServers, loadAllMcpServers, invalidateMcpCache } from '../../lib/mcp-loader';
