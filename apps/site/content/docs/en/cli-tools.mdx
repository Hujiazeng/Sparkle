...
Many AI workflows require command-line tools — FFmpeg for video processing, jq for JSON parsing, ripgrep for code search. Sparkle's CLI Tools feature helps you manage these tools and lets Claude automatically know what's available on your machine.
...
After installing tools, you don't need to do anything extra. Sparkle automatically detects your installed tools before each conversation and includes them in the system prompt.
