...
4. Once verified, click **Auto-detect Chat ID**:
   ...
   - Then click the detect button; Sparkle will automatically retrieve your Chat ID
...
1. Confirm the Sparkle bridge service is running (Bridge page shows "Connected")
