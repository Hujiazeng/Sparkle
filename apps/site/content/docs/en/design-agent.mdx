...
Design Agent is Sparkle's built-in AI image generation feature. It uses Claude to analyze your requirements, then calls the Gemini Image API to generate images.
