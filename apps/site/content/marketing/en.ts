...
export const en: MarketingContent = {
  hero: {
    notice: {
      ...
      english: 'Sparkle is being actively refactored for the next release: session-safe runtimes, background resident tasks and local notifications, scheduled AI work, stronger Markdown/Artifact previews, and local agent adapters such as Codex.',
      chinese: 'Sparkle 正在为下一轮发布进行产品重构：会话级 Runtime、后台常驻任务与本机通知、定时 AI 任务、Markdown / Artifact 预览，以及 Codex 等本地 Agent 适配会陆续稳定下来。',
      cta: 'Follow on GitHub',
      href: 'https://github.com/Hujiazeng/Sparkle',
    },
    title: 'Sparkle',
  ...
  openSource: {
    ...
    githubUrl: 'https://github.com/Hujiazeng/Sparkle',
  },
  faq: {
    ...
    items: [
      {
        q: 'Is Sparkle really free?',
        a: 'Yes. Sparkle is completely free and open source. You only pay for the API usage from your chosen provider.',
      },
      {
      ...
      },
      {
        ...
        a: 'No. Sparkle works with your own API key directly — no Claude Code subscription required.',
      },
      {
        q: 'Is my data sent to Sparkle servers?',
        a: 'No. All API calls go directly from your machine to the provider. Sparkle never sees your code or conversations.',
      },
      {
        q: 'Which platforms are supported?',
        a: 'Sparkle supports macOS (Apple Silicon & Intel), Windows (x64), and Linux (x64 & arm64). Download the latest version for your platform from the GitHub releases page.',
      },
    ],
  },
  audience: {
  ...
  releases: {
    title: 'What\'s New',
    titleLight: 'in Sparkle',
    viewAll: 'View all releases on GitHub',
  },
  cta: {
    title: 'Ready to try Sparkle?',
    description: 'Download and connect your favorite AI provider in minutes.',
    primary: 'Download',
    secondary: 'Read the docs',
  },
  footer: {
    copyright: '\u00a9 2026 Sparkle',
    links: [
      { text: 'GitHub', url: 'https://github.com/Hujiazeng/Sparkle' },
      { text: 'Docs', url: '/docs' },
