...
export const zh: MarketingContent = {
  ...
  faq: {
    ...
    items: [
      {
        q: 'Sparkle 真的免费吗？',
        a: '是的。Sparkle 完全免费且开源，你只需为所选 Provider 的 API 用量付费。',
      },
      {
        q: '支持哪些 AI 服务商？',
      ...
      },
      {
        ...
        a: '不需要。Sparkle 直接使用你自己的 API Key，无需 Claude Code 订阅。',
      },
      {
        q: '我的数据会发送到 Sparkle 服务器吗？',
        a: '不会。所有 API 调用从你的电脑直接发送到 Provider，Sparkle 不会接触你的代码或对话。',
      },
      {
        q: '支持哪些平台？',
        a: 'Sparkle 支持 macOS（Apple Silicon 和 Intel）、Windows（x64）以及 Linux（x64 和 arm64）。前往 GitHub Releases 页面下载对应平台的最新版本。',
      },
    ],
  },
  audience: {
